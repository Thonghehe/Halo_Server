...
function Orders() {
  ...
  // Reset loading state khi component mount lại (khi navigate từ màn hình khác về)
  useEffect(() => {
    // Nếu React Query đã có data trong cache và không đang loading, reset loading state ngay
    if (!ordersLoading && ordersResp) {
      setTableLoading(false);
      setPageLoading(false);
    }
  }, []); // Chỉ chạy khi mount
