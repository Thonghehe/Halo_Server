...
const ReasonModal = ({ show, onClose, onConfirm, title, placeholder, loading = false }) => {
        ...
        <div className="order-detail-modal-content">
          ...
          <div className="order-detail-modal-footer">
            <div className="d-flex justify-content-end gap-2 w-100">
              ...
              <button type="button" className="btn btn-primary" onClick={handleConfirm} disabled={!String(reason).trim() || loading}>
